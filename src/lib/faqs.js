const FAQs = [
  ...
  {
    question: "Does Text The Vote use my personal phone number to text people?",
    answer:
  ...
  {
    question: "Is Text The Vote available as an Android/iPhone app?",
    answer:
      "Text The Vote is a web-based program you can access from any web browser on your computer, tablet or mobile " +
